...
const TopNav = ({ history, user }) => {
  ...
  return (
    <Menu className="TopNav" stackable>
      ...
      <Menu.Item name="/new-list" onClick={handleItemClick}>
        New List
      </Menu.Item>
      <Dropdown item text="Lists">
        <Dropdown.Menu>
          <Dropdown.Item name="/lists/saved" onClick={handleItemClick}>
            Saved
          </Dropdown.Item>
          <Dropdown.Item name="/lists/starred" onClick={handleItemClick}>
            Starred
          </Dropdown.Item>
          <Dropdown.Item name="/lists/popular" onClick={handleItemClick}>
            Popular
          </Dropdown.Item>
          <Dropdown.Item name="/lists/all" onClick={handleItemClick}>
            All
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
      {user.authRequestMade &&
        <Menu.Menu position="right">
          {!user.uid &&
            <Menu.Item name="/sign-in/new" onClick={handleItemClick}>
              Sign Up
            </Menu.Item>}
          {!user.uid &&
